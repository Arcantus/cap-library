...
public class CapUtil {
     ...
     * by getRepeatedFieldNames().get("info").
     *
    ...
    /**
     * Returns true if the string is null or { s.trim()}
    ...
    /**
     * Returns { true} if the string represents base64-encoded content,
     * { false} otherwise.
     *
     * <p>The input string cannot be { null}, but can be empty. In this
     * case, the function would return { true}.
     *
     ...
     *
     * @param capIdentifier Identifier.
     * @param capSender     sender
     * @param sent          to sent the value
     ...
     * Returns a string legal for use in a CAP {@literal <references>} parameter.
     *
     * @param capSender string
     * @param capIdentifier string
     * @param sent string
     ...
     * <p>{ null} is returned if the string does not match the spec.
     *
     * @param s string
     * @return URI
     */
     ...
     * @return {true} if the input string contains HTML entities, {false}
     * otherwise
     */
    ...
    /**
     * @param s String value.
     * @return {true} if the input string contains HTML tags, {false} otherwise
     */
